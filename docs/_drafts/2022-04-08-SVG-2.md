...
Ahora, para acomodarlo hay que mover los nodos, no los tiradores, porque si no dejan de ser nodos suavizados. Es más fácil hacer circunferencias con este tipo de nodos. Listo:
